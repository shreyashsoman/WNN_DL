...
class WeightForecasting(tensorflow.keras.callbacks.Callback):
    def __init__(self):
        ...
        self.model2.load_weights("C:\\Users\\shreyash\\Downloads\\WNN-main\\WNN_PT\\NWNN_Conv_13.h5")
        
        self.model3 = WNN(5)
        self.model3.compile(loss='mae', optimizer=Adam(),metrics=['mae'])
        self.model3.load_weights("C:\\Users\\shreyash\\Downloads\\WNN-main\\WNN_PT\\NWNN_FC_13.h5")						

        self.model4 = WNN(5)
        self.model4.compile(loss='mae', optimizer=Adam(),metrics=['mae'])       
        self.model4.load_weights("C:\\Users\\shreyash\\Downloads\\WNN-main\\WNN_PT\\NWNN_Bias_13.h5")
        self.cnt=0
