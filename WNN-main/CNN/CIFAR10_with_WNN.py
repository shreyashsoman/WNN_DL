...
for trial in range(1):
	...
	ValLoss = []
	ValAcc = []
	hist = model.fit_generator(datagen.flow(x_train, y_train, batch_size=batch_size),steps_per_epoch=10,epochs=10, verbose=1, workers=1,validation_data = (x_test, y_test) , callbacks=[WeightForecasting()])
